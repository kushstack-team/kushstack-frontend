              ...
              <div className="team-member-connect-box">
                ...
                <div className="team-member-socials">
                  {person.socials.linkedin && (
                    <a href={person.socials.linkedin} className="team-member-social-link">
                      <Linkedin className="team-member-social-icon" />
                    </a>
                  )}
                  {person.socials.github && (
                    <a href={person.socials.github} className="team-member-social-link">
                      <Github className="team-member-social-icon" />
                    </a>
                  )}
                  {person.socials.twitter && (
                    <a href={person.socials.twitter} className="team-member-social-link">
                      <Twitter className="team-member-social-icon" />
                    </a>
                  )}
                </div>
              </div>
              ...
              <div className="team-member-skills-grid">
                <div>
                  <div className="team-member-skills-header">
                    ...
                    <h3 className="team-member-skills-title">Core Skills</h3>
                  </div>
                ...
                <div>
                  <div className="team-member-skills-header">
                    ...
                    <h3 className="team-member-skills-title">Technologies</h3>
                  </div>
